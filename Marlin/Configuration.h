...
#define STRING_CONFIG_H_AUTHOR "(myj, delta mini)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mega_mini"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 65 // mm
  ...
  #define DELTA_DIAGONAL_ROD 190.0 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 149.00 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 86.4 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 600 }  // default steps per unit for Kossel (GT2, 20 tooth)
